...
<div>
    ...
    <form action="taikhoan" method="post">
    	<label>Id: </label><input type="text" name="id_tk" value="${lp.id_lp }"><br/>
        <label>Tên loại phòng: </label><input type="text" name="tenloai" value="${lp.tenloai }"><br/>
			...
			<tbody>
				<c:forEach items="${lp.phongs}" var="phong" varStatus="STT">
						<tr>
							...
							<td>${phong.id_p}</td>
							<td>
								<a href="<c:url value="/admin/phong?id_p=${phong.id_p }"/>">
							...
							<td><a href="<c:url value="/admin/xoa-phong?id_p=${phong.id_p }&id_loaip=${lp.id_lp }"/>">Xóa</a></td>
