...
{
	public static final String[] thutu = {"phong.id_p", "phong.ngaydang", "phong.ngaydang DESC", "phong.gia", "phong.gia DESC", "danhgia", "danhgia DESC"};
	...
	public static final String subMailUserdh = "Lịch đặt hẹn";
	public static final String subMailSellerdh = "Thông báo có người muốn xem phòng";

	
	public static final String thanksMail = "Cảm ơn đã sử dụng dịch vụ của findroom";
